    ...
    <S.Container>
      ...
      <S.warp>
        <S.touch onPress={() => setRelationType(5)} >
          ...
          <TextStyle style={{ textAlign: 'center' }} type={relationType === 5 ? 'defaultSemiBold' : 'default'} >Presenças</TextStyle>
        </S.touch>

        <S.touch onPress={() => setRelationType(6)} >
          <HandHeart weight={focusWeight(6)} color={focusType(6)} size={icosize} />
          <TextStyle style={{ textAlign: 'center' }} type={relationType === 6 ? 'defaultSemiBold' : 'default'} >Donativos</TextStyle>
        </S.touch>

        <S.touch onPress={() => setRelationType(7)} >
          <UserPlus weight={focusWeight(7)} color={focusType(7)} size={icosize} />
          <TextStyle style={{ textAlign: 'center' }} type={relationType === 7 ? 'defaultSemiBold' : 'default'} >Convidados</TextStyle>
        </S.touch>

        <S.touch onPress={() => setRelationType(9)} >
          <PersonSimpleRun weight={focusWeight(9)} color={focusType(9)} size={icosize} />
          <TextStyle style={{ textAlign: 'center' }} type={relationType === 9 ? 'defaultSemiBold' : 'default'} >Corridas</TextStyle>
        </S.touch>
